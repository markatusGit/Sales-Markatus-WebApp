...
| Lokale Prüfungen des Testmoduls | Elf Benchmark- und neun Umsatztests mit nachgebildeten Google-Diensten bestanden; Syntax und Manifest geprüft | Korrektur für fehlende Belegdaten noch nicht real in HQ bestätigt |
