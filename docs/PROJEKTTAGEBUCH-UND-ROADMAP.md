...
**Sicherungsstand:** Dateien und Dokumentation lokal vorbereitet und geprüft; die gezielte GitHub-Sicherung folgt unmittelbar. Google-Bereitstellung und r7-Live-Test stehen aus. Automatische zeitversetzte/nächtliche Verarbeitung, Google-Login für weitere Nutzer und die übrige Roadmap bleiben nach erfolgreicher Kontaktabnahme offen.
